		...
		<body class='login-body'>
			<div className='login-container'>
				...
				<div className='form-group'>
					...
					<input type='password' value={password} onChange={handlePasswordChange} placeholder='Create your password' />
				</div>
				<div className='password-constraints'>
					<CheckCircleIcon
						style={{ color: atLeastEightCharacters ? 'green' : '#D0D5DD', fontSize: '20px', marginRight: '5px' }}
					/>
					Пароль должен содержать минимум 8 символов
				</div>
				<div className='password-constraints'>
					<CheckCircleIcon
						style={{ color: hasSpecialCharacter ? 'green' : '#D0D5DD', fontSize: '20px', marginRight: '5px' }}
					/>
					Пароль должен содержать хотя бы один специальный символ
				</div>
				<button className='create-account-button'>Get started</button>
