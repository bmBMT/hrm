	...
	return (
		<div className='form-group'>
			<div className='check-div'>
				{valid && !value && <CheckCircleIcon style={{ color: 'green', fontSize: '20px' }} />}
				<label>{`${title}*:`}</label>
			</div>
			<input
				name={name}
		...
		<div className='sign-up-body'>
			<div className='sign-up-container'>
				...
				<form onSubmit={handleSubmit}>
					...
					<Constraint text={'Пароль должен содержать минимум 8 символов'} passed={validators.length} />
					<Constraint text={'Пароль должен содержать хотя бы одну цифру'} passed={validators.number} />
					<Constraint
