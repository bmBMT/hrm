...
export default function OnboardingDocuments({
	...
	return (
		...
		>
			{/*Title*/}
			<h4 style={{ textAlign: 'center', marginTop: 0, marginBottom: '10px' }}>Ознакомьтесь с документами ниже</h4>
			<p style={{ textAlign: 'center', marginBottom: '50px' }}>
				Вы можете просмотреть документы в любом браузере или программе для просмотра PDF.
			</p>
			{/*Content*/}
			...
			<Stack direction='row' alignItems='center' spacing={1} sx={{ marginBottom: '30px' }}>
				...
				/>
				<p>
					Я прочитал документы<span style={{ color: 'red' }}>*</span>
				</p>
			</Stack>
			{/*Buttons*/}
			<Stack direction='row' alignContent='center' justifyContent='space-between'>
				...
				<Stack direction='row' alignContent='center' spacing={2}>
					...
					<HRMButton mode='primary' enabled={readDocuments} onClick={next}>
