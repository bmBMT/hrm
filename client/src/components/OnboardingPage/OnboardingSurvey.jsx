	...
	return (
		...
		>
			...
			<h4 style={{ textAlign: 'center', marginTop: 0, marginBottom: '10px' }}>
				Пожалуйста, ответьте на вопросы ниже максимально подробно.
			</h4>
			<p style={{ textAlign: 'center', marginBottom: '50px' }}>
				Ваши ответы будут использованы для совершенствования наших процессов.
			</p>
			{/*Content*/}
			{survey
			...
			<Stack direction='row' alignContent='center' justifyContent='space-between'>
				...
				<Stack direction='row' alignContent='center' spacing={2}>
					<HRMButton mode='secondaryB' onClick={saveSurvey}>
