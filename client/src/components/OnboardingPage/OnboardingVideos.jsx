...
export default function OnboardingVideos({ prev, next, save, watchedVideos, setWatchedVideos, style }) {
	...
	return (
		...
		>
			...
			<p style={{ textAlign: 'center', marginBottom: '50px' }}>Вы можете просмотреть видео и pdf на любом браузере</p>
			{/*Content*/}
			{videos.map(video => (
				<>
			...
			<Stack direction='row' alignItems='center' spacing={1} sx={{ marginBottom: '30px' }}>
				...
				/>
				<p>
					Я просмотрел видео.<span style={{ color: 'red' }}>*</span>
				</p>
			</Stack>
			{/*Buttons*/}
			<Stack direction='row' alignContent='center' justifyContent='space-between'>
				...
				<Stack direction='row' alignContent='center' spacing={2}>
					...
					<HRMButton mode='primary' enabled={watchedVideos} onClick={next}>
						Сохранить
					</HRMButton>
				</Stack>
			</Stack>
