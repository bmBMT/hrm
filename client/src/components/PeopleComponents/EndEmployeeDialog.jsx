			...
			>
				<Stack direction='column' spacing={2} sx={{ padding: '36px' }}>
					<Stack direction='row' alignItems='center' justifyContent='space-between' sx={{ marginBottom: '30px' }}>
						<Typography variant='h2'>Завершить трудовые отношения</Typography>
						<CloseIcon
							onClick={handleClose}
							sx={{
					...
					<Typography variant='body1'>Причина</Typography>
					<Autocomplete
						disablePortal
							...
							<Grid container direction='column' spacing={2}>
								<Grid item>
									<FormControlLabel
										...
										label={<Typography variant='body2'>Завершить трудовые отношения сейчас</Typography>}
										sx={{ paddingX: '5px' }}
									/>
								</Grid>
								...
								<Grid item>
									<FormControlLabel
										...
										sx={{ paddingX: '5px' }}
										label={<Typography variant='body2'>Завершить трудовые отношения позже</Typography>}
									/>
								</Grid>
					...
					<Typography variant='body1'>Заметки</Typography>
					<TextField
						id='description'
						multiline
						rows={4}
