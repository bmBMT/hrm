...
import { styled, createTheme, ThemeProvider, Dialog, Snackbar, Alert as MuiAlert } from '@mui/material';
...
export default function ActionButtonEmployee({ empId, open, onClose }) {
	...
	return (
		<ThemeProvider theme={customTheme}>
			...
			>
				<StyledAlert onClose={() => setOpenSuccessPopup(false)}>Трудовые отношения успешно прекращены!</StyledAlert>
			</Snackbar>
		</ThemeProvider>
	);
}
