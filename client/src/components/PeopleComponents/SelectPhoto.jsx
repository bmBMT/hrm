...
const SelectPhoto = props => {
	...
	return (
		<Stack spacing={2} alignContent={'flex-start'} direction={'row'}>
			...
			>
				<Stack direction='column' alignItems='center' justifyContent='center' spacing={1} sx={{ height: '100vh' }}>
					<CloudUploadOutlinedIcon sx={{ border: '1px solid #EAECF0', borderRadius: '8px' }} />
					<Stack direction='row'>
						<input
							type='file'
							ref={fileInputRef}
