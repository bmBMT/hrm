	...
	return (
		...
		>
			...
			<p style={{ marginBottom: '40px' }}>
				При удалении этого запроса на отгул вашему руководителю будет отправлено подтверждающее сообщение.
			</p>
			{/*Buttons*/}
			<Stack direction='row' alignItems='center' justifyContent='flex-end' spacing={2}>
				<HRMButton mode='tertiary' onClick={close}>
					Отмена
				</HRMButton>
				<HRMButton mode='error' onClick={handleDelete}>
					Удалить
				</HRMButton>
			</Stack>
		</Box>
