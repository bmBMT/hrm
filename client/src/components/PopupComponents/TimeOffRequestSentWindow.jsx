...
export default function TimeOffRequestSentWindow({request_information, close, style}) {
    ...
    return (
        <Box sx={{...{
            ...
            >
                <h3>Ваш запрос на отпуск отправлен.</h3>
            ...
            <table style={{width: "100%", marginBottom: "40px"}}>
                <tr>
                    <StyledTD><b>Количество выходных</b></StyledTD>
                    <StyledTD>{request_information.timeOffBalance}</StyledTD>
                </tr>
                <tr>
                    <StyledTD><b>Запрошенные выходные</b></StyledTD>
                ...
                <tr>
                    <StyledTD><b>Категория выходного</b></StyledTD>
