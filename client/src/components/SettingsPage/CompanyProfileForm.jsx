...
import { styled, TextField as MUITextField, Typography, Autocomplete } from '@mui/material';
		...
		<form>
			...
			>
				<Grid container columns={10} rowSpacing={4} columnSpacing={1}>
					<Grid item xs={10}>
						<HeadText>Редактировать информацию профиля компании</HeadText>
					</Grid>
					...
					<Grid item xs={7} alignContent='center'>
						<TextField
							...
							helperText={errors.companyDomain ? 'Company domain is required.' : ''}
							size='small'
							color='secondary'
						/>
					</Grid>
					...
					<Grid item xs={3}>
						<Text>Email администратора</Text>
					</Grid>
					<Grid item xs={7} alignContent='center'>
						<TextField
							fullWidth
							...
							helperText={errors.administratorEmail ? 'Invalid email address.' : ''}
							size='small'
							color='secondary'
						/>
					</Grid>
					...
					<Grid item xs={7} alignContent='center'>
						<TextField fullWidth size='small' inputProps={{ ...register('unitSuite') }} color='secondary' />
					</Grid>
					{/*Textfield for city*/}
					<Grid item xs={3}>
						<Text>Город</Text>
					...
					<Grid item xs={7} alignContent='center'>
						<TextField
							...
							helperText={errors.postalZipCode ? 'Postal Code is required.' : ''}
							color='secondary'
						/>
					</Grid>
				...
				<Grid item xs={10} alignContent='right'>
					<Toast open={toast.open} severity={toast.severity} message={toast.message} onClose={handleClose} />
				</Grid>
			</Box>
		</form>
	);
