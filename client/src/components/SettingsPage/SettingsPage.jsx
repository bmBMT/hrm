      ...
      >
        <TabContext value={tab}>
          <Box sx={{ borderBottom: 1, borderColor: "#EAECF0" }}>
            ...
            >
              <StyledTab label="Профиль компании" value="Company profile" />
              <StyledTab label="Отделы" value="Departments" />
              <StyledTab label="Должности" value="Job titles" />
              <StyledTab label="Выходные" value="Time off" />
              <StyledTab label="Разрешения" value="Permissions" />
          ...
          <StyledTabPanel value="Time off">
            <ListTabContent
              ...
              titleTabPage="Политика выходных"
