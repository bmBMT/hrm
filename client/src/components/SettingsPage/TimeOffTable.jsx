				...
				<TableHead>
					<TableRow sx={{ backgroundColor: '#F9FAFB' }}>
						<TableHeaderCell sx={{ width: '50%', paddingLeft: '25px' }}>
							<TextHeader>Политика выходных</TextHeader>
						</TableHeaderCell>
						<TableHeaderCell>
							<TextHeader>Количество часов по умолчанию</TextHeader>
						</TableHeaderCell>
						<TableHeaderCell>
							<TextHeader>Кол-во использованного времени</TextHeader>
						</TableHeaderCell>
						...
						<TableRow key={item.id}>
							...
							<TableBodyCell>
								<Stack direction='row' alignItems='center' justifyContent='flex-start'>
									...
									<EditButton onClick={() => openDialog(item, 'edit')}>Редактировать</EditButton>
								</Stack>
							</TableBodyCell>
						</TableRow>
					))}
