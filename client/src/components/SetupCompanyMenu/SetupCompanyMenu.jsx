...
export default function SetupCompanyMenu({ advancePage, style }) {
	...
	return (
		...
		>
			<h3 style={{ textAlign: 'center', marginTop: 0, marginBottom: '10px' }}>Введите основные сведения о компании</h3>
			<p style={{ textAlign: 'center', marginBottom: '50px' }}>Вы можете изменить их в позже настройках</p>
			...
			<Stack direction='row' alignItems='center' justifyContent='space-between' sx={{ marginBottom: '40px' }}>
			...
			<Stack direction='row' alignItems='center' justifyContent='flex-end'>
				<HRMButton mode='primary' enabled={companyName} onClick={handleSubmit}>
					Создать компанию
				</HRMButton>
			</Stack>
		</Box>
