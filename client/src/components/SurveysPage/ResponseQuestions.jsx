 ...
 *      Default: {}
 */
export default function ResponseQuestions({ prev, next, save, surveyData, setResponse, style }) {
	...
	return (
		...
		>
			...
			<h4 style={{ textAlign: 'center', marginTop: 0, marginBottom: '10px' }}>
				Пожалуйста, ответьте на приведённые ниже вопросы максимально подробно.
			</h4>
			<p style={{ textAlign: 'center', marginBottom: '50px' }}>
				Ваши ответы будут использованы для дальнейшего совершенствования наших процессов.
			</p>
			{/*Content*/}
