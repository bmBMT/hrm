...
export default function ResponseMessage({ surveyName, next, style }) {
	return (
		...
		>
			{/*Title*/}
			<h4 style={{ textAlign: 'center', marginTop: 0, marginBottom: '10px' }}>{surveyName}</h4>
			{/*Content*/}
			<p>
				Благодарим вас за время, уделенное для обратной связи. Ваше мнение бесценно для улучшения вашего опыта работы. Пожалуйста, будьте искренни в ответах — ваши отзывы останутся конфиденциальными.
			</p>
			{/*Buttons*/}
