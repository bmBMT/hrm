...
export default function UpdatesFilter({filter, handleFilter, style}) {
    return (
        ...
        >
            <ToggleButton value="All" disableTouchRipple sx={{textTransform: "none", paddingY: "4px"}}>Все</ToggleButton>
            <ToggleButton value="Unread" disableTouchRipple sx={{textTransform: "none", paddingY: "4px"}}>Не прочитанные</ToggleButton>
        </ToggleButtonGroup>
    );
};
