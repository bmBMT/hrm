...
const columns = employeeMap => [
			...
			return (
				<Box>
					<Box sx={{ display: 'flex', alignItems: 'center' }} key='change-from'>
						<Typography variant='body5'>From:&nbsp;</Typography>
						<Typography variant='body1'>{changeFrom}</Typography>
					</Box>
					<Box sx={{ display: 'flex', alignItems: 'center' }} key='change-to'>
						<Typography variant='body5'>To:&nbsp;</Typography>
						<Typography variant='body1'>{changeTo}</Typography>
					</Box>
				</Box>
			);
		},
	},
	{
		...
		renderCell: params => (
			...
			>
				<Typography variant='body4'>{params.value}</Typography>
			</Box>
		),
	},
];
